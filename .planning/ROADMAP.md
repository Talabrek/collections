...
Plans:
- [ ] 02-01: Fix getProgress() race condition and add load-blocking gate
- [ ] 02-02: Migrate BukkitScheduler to Folia-compatible schedulers
- [ ] 02-03: Audit ConcurrentHashMap operations and PlayerProgress thread safety
